...
.DESCRIPTION
    ...
    Install paths:
      • -Version vX.Y.Z → fetch cli.zip from the
...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/cli-install.ps1))) -Version v3.41.0 -TargetDir .\vendor
#>
...
$BundleName = "cli"
$BundleFoldersSrc = "spec/11-powershell-integration,spec/12-cicd-pipeline-workflows,spec/13-generic-cli,spec/14-update,spec/15-distribution-and-runner,spec/16-generic-release"
