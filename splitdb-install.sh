...
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/splitdb-install.sh | bash -s -- --version v3.41.0
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/splitdb-install.sh | bash -s -- --target-dir ./vendor
#
# Install paths:
#   • --version vX.Y.Z → fetch splitdb.tar.gz from
...
BUNDLE_NAME="splitdb"
BUNDLE_FOLDERS_SRC="spec/04-database-conventions,spec/05-split-db-architecture,spec/06-seedable-config-architecture"
