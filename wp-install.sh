...
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/wp-install.sh | bash -s -- --version v3.41.0
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/wp-install.sh | bash -s -- --target-dir ./vendor
#
# Install paths:
#   • --version vX.Y.Z → fetch wp.tar.gz from
...
BUNDLE_NAME="wp"
BUNDLE_FOLDERS_SRC="spec/18-wp-plugin-how-to"
BUNDLE_MAPPING="spec/18-wp-plugin-how-to|spec/18-wp-plugin-how-to"
