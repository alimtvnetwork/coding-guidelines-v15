...
.DESCRIPTION
    ...
    Install paths:
      • -Version vX.Y.Z → fetch splitdb.zip from the
...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/splitdb-install.ps1))) -Version v3.41.0 -TargetDir .\vendor
#>
...
$BundleName = "splitdb"
$BundleFoldersSrc = "spec/04-database-conventions,spec/05-split-db-architecture,spec/06-seedable-config-architecture"
