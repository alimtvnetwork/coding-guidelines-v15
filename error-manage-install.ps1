...
.DESCRIPTION
    ...
    Install paths:
      • -Version vX.Y.Z → fetch error-manage.zip from the
...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/error-manage-install.ps1))) -Version v3.41.0 -TargetDir .\vendor
#>
...
$BundleFoldersSrc = "spec/01-spec-authoring-guide,spec/03-error-manage"
