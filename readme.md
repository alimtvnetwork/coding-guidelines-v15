...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FILES -->611<!-- /STAMP:FILES --> spec files · <!-- STAMP:FOLDERS -->22<!-- /STAMP:FOLDERS --> top-level folders · <!-- STAMP:LINES -->131,648<!-- /STAMP:LINES --> lines · v<!-- STAMP:VERSION -->3.63.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-04-22<!-- /STAMP:UPDATED -->
</p>
