...
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/linters-install.sh | bash -s -- --version v3.41.0
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/linters-install.sh | bash -s -- --target-dir ./vendor
#
# Install paths:
#   • --version vX.Y.Z → fetch linters.tar.gz from
...
BUNDLE_NAME="linters"
BUNDLE_FOLDERS_SRC="linters,linters-cicd"
BUNDLE_MAPPING="linters|linters linters-cicd|linters-cicd"
ARCHIVE_STABLE_NAME="linters"
