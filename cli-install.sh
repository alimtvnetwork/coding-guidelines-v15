...
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/cli-install.sh | bash -s -- --version v3.40.0
...
BUNDLE_NAME="cli"
BUNDLE_FOLDERS_SRC="spec/11-powershell-integration,spec/12-cicd-pipeline-workflows,spec/13-generic-cli,spec/14-update,spec/15-distribution-and-runner,spec/16-generic-release"
