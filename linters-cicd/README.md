...
```bash
curl -fsSL https://github.com/alimtvnetwork/coding-guidelines-v14/releases/latest/download/install.sh | bash
...
| Channel | How |
|---------|-----|
| GitHub composite Action | `uses: alimtvnetwork/coding-guidelines-v14/linters-cicd@vX.Y.Z` |
