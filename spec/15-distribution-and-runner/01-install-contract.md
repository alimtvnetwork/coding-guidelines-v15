...
When invoked with no flags, both installers MUST pull the following four folders from `alimtvnetwork/coding-guidelines-v14@main` and unpack them into the **current working directory**:
