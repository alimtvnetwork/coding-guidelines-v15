...
repository (e.g. `coding-guidelines-v5` → `coding-guidelines-v14`) and,
...
```
▸ Detecting installer identity...
✓ Identity: alimtvnetwork/coding-guidelines-v14  (probing v15..v34)
▸ Probing 20 candidate versions in parallel (timeout 2s)...
...
| `irm .../coding-guidelines-v14/main/install.ps1 \| iex`, no v15..v34 | Falls through to local install. |
