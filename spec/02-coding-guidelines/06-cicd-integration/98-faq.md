...
```yaml
- uses: alimtvnetwork/coding-guidelines-v14/linters-cicd@a3c91f2b8d4e5f6789012345678901234567890a
```
...
LINTERS_VERSION=v3.9.0 \
  curl -fsSL https://github.com/alimtvnetwork/coding-guidelines-v14/releases/download/v3.9.0/install.sh \
  | bash
```
...
```bash
VERSION=v3.9.0
curl -fsSLO "https://github.com/alimtvnetwork/coding-guidelines-v14/releases/download/${VERSION}/coding-guidelines-linters-${VERSION}.zip"
