...
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/consolidated-install.sh | bash -s -- --version v3.41.0
#   curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/consolidated-install.sh | bash -s -- --target-dir ./vendor
#
# Install paths:
#   • --version vX.Y.Z → fetch consolidated.tar.gz from
...
BUNDLE_FOLDERS_SRC="spec/01-spec-authoring-guide,spec/03-error-manage,spec/17-consolidated-guidelines"
